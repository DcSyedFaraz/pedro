    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item {{ request()->routeIs('manager.dashboard') ? 'menu-open' : '' }} ">
            <a href="#" class="nav-link nav-dropdown-toggle {{ request()->routeIs('manager.dashboard') ? 'active' : '' }}">
            ...
            <ul class="nav nav-treeview">
             ...
             ">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('responce.index')}}" class="nav-link {{ request()->routeIs('responce.index')? 'active' : '' }} {{ request()->routeIs('responce.show')? 'active' : '' }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Responce</p>
                  </a>
                </li>
