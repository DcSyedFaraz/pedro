...
<!-- Include the JavaScript for dynamic rows -->
{{-- @push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            <tr>
                <td colspan="2">
                    <input type="text" class="form-control est_inv_desc" name="description[]" placeholder="{{ __('admin/estimates/edit.description') }}">
                </td>
                <td>
                    <input type="number" class="form-control est_inv_qty" name="qty_hrs[]" placeholder="{{ __('admin/estimates/edit.qty') }}">
                </td>
                <td>
                    <input type="number" class="form-control est_inv_rate" name="rate[]" placeholder="{{ __('admin/estimates/edit.rate') }}">
                </td>
                <td>
                    <input type="text" class="form-control est_inv_tax" name="margin_tax[]" placeholder="{{ __('admin/estimates/edit.tax') }}">
                </td>
                <td>
                    <input type="number" class="form-control est_inv_total" name="total[]" placeholder="{{ __('admin/estimates/edit.total') }}" readonly>
                </td>
                <td>
                    <input type="number" class="form-control est_inv_cost" name="cost[]" placeholder="{{ __('admin/estimates/edit.cost') }}">
                </td>
                <td>
                    <button type="button" class="btn remove-button">
                        <i class="fas fa-minus text-danger"></i>
        ...
        `;
            ...
            // Optional: Handle real-time calculations (e.g., total = qty * rate + tax)
