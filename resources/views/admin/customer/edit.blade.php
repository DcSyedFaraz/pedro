                            ...
                            <div class="card-header">
                                <form action="{{ route('customer.update', $customer->id) }}" method="POST">
                                    ...
                                    <div class="inner-section-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    @foreach ($customer->service as $service)
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" value="{{ old('nick_name', $service->nick_name) }}"
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select form-control"
                                                                    ...
                                                                    <option value="contact 1" {{ old('contact_type', $service->contact_type) == 'contact 1' ? 'selected' : '' }}>contact 1</option>
                                                                    <option value="contact 2" {{ old('contact_type', $service->contact_type) == 'contact 2' ? 'selected' : '' }}>contact 2</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <a href="{{ route('service.destroy', $service->id)}}" type="button" id="remove-ser" class="add-more-btn mt-4"><i class="fas fa-trash text-danger"></i></a>
                                                            </div>
                                                        <div class="col-sm-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" name="aptNo[]" value="{{ old('aptNo', $service->aptNo) }}"
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="city[]" class="form-control" value="{{ old('city', $service->city) }}"
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="state[]" class="form-control" value="{{ old('state', $service->state) }}"
                                                                id="exampleInputstate" placeholder="State Province">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <div class="mb-3">
                                                            <label for="exampleInputzip" class="form-label">Zip/Postal
                                                                Code</label>
                                                            <input type="text" name="zip[]" class="form-control" value="{{ old('zip', $service->zip) }}"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="estimate-div" class="form-label">Estimate
                                                    Template</label>
                                                <select class="form-select form-control" name="estimate_template"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="invoice-div" class="form-label">Invoice
                                                    Template</label>
                                                <select class="form-select form-control" name="invoice_template"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="exampleInputcustomertag" class="form-label">Customer
                                                    Tags</label>
                                                <input type="text" class="form-control" id="exampleInputcustomertag"
                                                    placeholder="Customer Tags">
                                            </div>
                                            <div class="mb-3">
                                                <label for="referral-div form-control" class="form-label">Referral
                                                    Source</label>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                <label for="referral-div" class="form-label">Assigned
                                                    Contract</label>
                                                <select class="form-select form-control" name="assigned_contract"
                                                    aria-label="Default select example" id="referral-div">
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputnumber" class="form-label">Business #
                                                    & Tax ID</label>
                                                <input type="text" class="form-control" name="bussiness_id"
                                                ...
                                                <div class="agent-inner-div">
                                                    <div class="commission-div">
                                                        <label for="agent-div" class="form-label">Assigned
                                                            Rep</label>
                                                        <select class="form-select form-control" name="assigned_rep[]"
                                                    ...
                                                    <div class="commission1-div">
                                                        ...
                                                        <select class="form-select form-control" name="commission_sign[]"
                                                            aria-label="Default select example" id="commission-div">
                                                            <option value="1">%</option>
                                                        </select>
                                                    </div>
                                                    <div class="commission2-div">
                                                        <input type="text" class="form-control" name="commission[]"
                                                            id="exampleInputcommtag">
                                                    </div>
