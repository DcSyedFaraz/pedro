    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Jobs Per Region</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Jobs Per Region</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            {{-- <tr>
                                                <th>City Name: <span class="text-danger">{{ $cityName }}</span></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                            </tr> --}}
                                        ...
                                        <tbody>
                                            @foreach ($jobByRegion as $jobs)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ isset($jobs->location_city) ? $jobs->location_city : '' }}
                                                    </td>
                                                    <td>
                                                        {{ isset($jobs->manager->name) ? $jobs->manager->name : '' }}
                                                    </td>
