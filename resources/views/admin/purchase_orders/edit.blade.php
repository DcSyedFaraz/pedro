            ...
            <div class="container-fluid">
                @if (count($errors) > 0)
                    <div class="alert alert-danger">
                        <strong>{{ __('admin/purchase_order/edit.whoops') }}!</strong> {{ __('admin/purchase_order/edit.there_were_some_problems_with_your_input') }}<br><br>
                        <ul>
                                            ...
                                            <div class="row bordewer">
                                                <div class="col-sm-12">
                                                    <div class="inner-header bg-colored pt-2 pb-2">
                                                        <h4 class="primary">{{ __('admin/purchase_order/edit.purchase_order') }}</h4>
                                                    </div>
                                                </div>
                                                <div class="innerinputs">
                                                    <div class="row">
                                                        <div class="col-lg-7">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label for="exampleInputcustomer" class="form-label">{{ __('admin/purchase_order/edit.supplier') }}</label>
                                                                    <select name="supplier" class="form-select form-control" aria-label="Default select example" id="vender-div">
                                                                        <option value="0" disabled selected hidden>{{ __('admin/purchase_order/edit.select_a_supplier') }}</option>
                                                                        <option value="1"{{ old('supplier', $purchaseOrder->supplier) == '1' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.supplier_1') }}</option>
                                                                        <option value="2"{{ old('supplier', $purchaseOrder->supplier) == '2' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.supplier_2') }}</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <label for="vender-div" class="form-label">{{ __('admin/purchase_order/edit.order_progress') }}</label>
                                                                    <select name="order_progress"
                                                                        class="form-select form-control"
                                                                        aria-label="Default select example" id="vender-div">
                                                                        <option value="Open"{{ old('order_progress', $purchaseOrder->order_progress) == 'Open' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.open') }}</option>
                                                                        <option value="Close"{{ old('order_progress', $purchaseOrder->order_progress) == 'Close' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.close') }}</option>
                                                                    </select>
                                                                </div>

                                                                <div class="col-sm-4">
                                                                    <label for="vender-div" class="form-label">Payment Term</label>
                                                                    <select name="payment_term"
                                                                        class="form-select form-control"
                                                                        aria-label="Default select example" id="vender-div">
                                                                        <option value="0" disabled selected hidden>{{ __('admin/purchase_order/edit.cash_on_delivery') }}</option>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-group">
                                                                        <label for="reference" class="form-label">{{ __('admin/purchase_order/edit.order_date') }}</label>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="purchase-order-status">
                                                                        <label for="vender-div" class="form-label">{{ __('admin/purchase_order/edit.sender_of_po') }}</label>
                                                                        <select name="sender"
                                                                            class="form-select form-control"
                                                                            aria-label="Default select example"
                                                                            id="vender-div">
                                                                            <option value="Not Sent"{{ old('sender', $purchaseOrder->sender) == 'Not Sent' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.not_sent') }}</option>
                                                                            <option value="Self"{{ old('sender', $purchaseOrder->sender) == 'Self' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.self') }}</option>
                                                                        </select></div>
                                                                </div>

                                                                <div class="col-sm-6">
                                                                    <div class="memo-main-div">
                                                                        <label for="reference" class="form-label">{{ __('admin/purchase_order/edit.memo_id') }}</label>
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <div class="sent-on-div">
                                                                        <label for="sent-on" class="form-label">{{ __('admin/purchase_order/edit.sent_date') }}</label>
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label for="vender-div" class="form-label">{{ __('admin/purchase_order/edit.receipt_status') }}</label>
                                                                    <select name="receipt_status"
                                                                        class="form-select form-control"
                                                                        aria-label="Default select example"
                                                                        id="vender-div">
                                                                        <option value="Not Received"{{ old('receipt_status', $purchaseOrder->receipt_status) == 'Not Received' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.not_received') }}</option>
                                                                        <option value="Received"{{ old('receipt_status', $purchaseOrder->receipt_status) == 'Received' ? 'selected' : '' }}>{{ __('admin/purchase_order/edit.received') }}</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="purchase-order-div">
                                                                        <label for="reference" class="form-label">{{ __('admin/purchase_order/edit.direct_shipping') }}</label>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-5">
                                                                                <input value="{{ old('tampa', $purchaseOrder->tampa ?? '') }}" name="tampa" type="text"
                                                                                    class="form-control" placeholder="{{ __('admin/purchase_order/edit.tampa') }}"
                                                                                    id="steunitapt">
                                                                            </div>
                                                                            <div class="col-sm-4">
                                                                                <input value="{{ old('fl', $purchaseOrder->fl ?? '') }}" name="fl" type="text"
                                                                                    class="form-control" placeholder="{{ __('admin/purchase_order/edit.fl') }}"
                                                                                    id="steunitapt">
                                                                            </div>
                                                                            <div class="col-sm-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="addproduct-div">
                                                                <label for="addproduct" class="form-label">{{ __('admin/purchase_order/edit.item_name') }}</label>
                                                                <input value="{{ old('item_name', $purchaseOrder->item_name ?? '') }}" name="item_name" type="text"
                                                                    class="form-control" placeholder="{{ __('admin/purchase_order/edit.add_product') }}"
                                                                    id="addproduct">
                                                        ...
                                                        <div class="col-sm-1">
                                                            <div class="addproduct-div">
                                                                <label for="addproduct" class="form-label">{{ __('admin/purchase_order/edit.quantity') }}</label>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="addproduct-div">
                                                                <label for="addproduct" class="form-label">{{ __('admin/purchase_order/edit.unit_price') }}</label>
                                                        ...
                                                        <div class="col-sm-2">
                                                            <div class="addproduct-div">
                                                                <label for="addproduct" class="form-label">{{ __('admin/purchase_order/edit.total_amount') }}</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-8">
                                                            <div class="message-main-div">
                                                                <label for="vender-div" class="form-label">Item Description</label>
                                                        ...
                                                        <div class="col-4 total-cost">
                                                            ...
                                                            <div class="inner-inner-inner">
                                                                <h5 style="color:green;">{{ __('admin/purchase_order/edit.received_discount') }} (-)</h5>
                                                            ...
                                                            <div class="inner-inner-inner">
                                                                <h5>{{ __('admin/purchase_order/edit.shipping_cost') }}</h5>
                                                                <input value="{{ old('ship_cost', $purchaseOrder->ship_cost ?? '0.00') }}" type="number" id="ship_cost" name="ship_cost"
                                                                    class="total" disabled >
                                                            </div>
                                                            <div class="inner-inner-inner">
                                                                <h5>{{ __('admin/purchase_order/edit.grand_total_price') }}</h5>
