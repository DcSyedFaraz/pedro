...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            <input value="{{ isset($job->first_name) ? old('first_name', $job->first_name) : '' }}" class="form-control" name="first_name" id="first_name" placeholder="First Name">
            <span class="error-message error-messages" id="first_name_error"></span><br>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <input value="{{ isset($job->last_name) ? old('last_name', $job->last_name) : '' }}" class="form-control" name="last_name" id="last_name" placeholder="Last Name">
...
@if (isset($job->jobPri))
            ...
            <div class="email_append">
                <div class="row">
                    ...
                    @if (!$loop->last)
                    <div class="col-md-2">
                        <a href="{{route('jobpri.destroy',$jobprim->id)}}" class="btn"><i class="fas fa-trash text-danger"></i></a>
                    </div>
                    @else
...
<div class="row">
    ...
    <div class="col-md-4">
        <input
        {{ isset($job->location_gated_property) && $job->location_gated_property ? 'checked' : '' }}
        ...
        <div class="form-group">
            ...
            <select id="job-cat-id" name="job_cat_id" class="form-control">
                ...
                @foreach ($jobCategories as $category)
                    <option {{ isset($job->job_cat_id) ? (old('job_cat_id', $job->job_cat_id) ? 'selected' : '') : '' }}
        ...
        <div class="form-group">
            <select id="job_sour" name="job_source" class="form-control">
                ...
                @foreach ($job_source as $job_sour)
                    <option {{ isset($job->job_source) ? (old('job_source', $job->job_source) ? 'selected' : '') : '' }}
