                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <form method="POST" action="{{ route('estimate_requests.update',$estimate->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        <label for="street_address">{{ __('admin/estimatereq/index.street_address') }}</label>
                                    ...
                                    <div class="form-group">
                                        <label for="details">{{ __('admin/estimatereq/index.please_enter_details_of_requested_work_and/or_description_of_problem') }}</label>
                                    ...
                                    @endif
                                    <button type="submit" class="btn btn-success">{{ __('admin/estimatereq/index.update_request') }}</button>
                                </form>
                            </div>
                        </div>
                    </div>
