                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select name="vendor" class="form-select form-control"
                                                    ...
                                                    <option value="0" disabled selected hidden>Select a
                                                        Vendor</option>
                                                    <option value="Vendor 1"{{ old('vendor', $inventory->vendor) == 'Vendor 1' ? 'selected' : '' }}>Vendor 1</option>
                                                    <option value="Vendor 2"{{ old('vendor', $inventory->vendor) == 'Vendor 2' ? 'selected' : '' }}>Vendor 2</option>
                                                </select>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="datepicker">
                                                        <input  value="{{ old('date', $inventory->date) }}" name="date" type="date"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="paid_for" class="form-select form-control"
                                                        ...
                                                        <option value="0" disabled selected hidden>Check /
                                                            ACH</option>
                                                        <option value="Paypal"{{ old('paid_for', $inventory->paid_for) == 'Paypal' ? 'selected' : '' }}>Paypal</option>
                                                        <option value="Stripe"{{ old('paid_for', $inventory->paid_for) == 'Stripe' ? 'selected' : '' }}>Stripe</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <input  value="{{ old('paid', $inventory->paid) }}" name="paid" type="number" class="form-control"
                                    ...
                                    <div class="innerinputs">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input  value="{{ old('receive', $inventory->receive) }}" name="receive" type="text" class="form-control"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="product-main-div">
                                                    ...
                                                    <select name="product" class="form-select form-control"
                                                        ...
                                                        <option value="0" disabled selected hidden>Select a
                                                            Product</option>
                                                        <option value="1" {{ old('product', $inventory->product) == '1' ? 'selected' : '' }}>Product 1</option>
                                                        <option value="2"{{ old('product', $inventory->product) == '2' ? 'selected' : '' }}>Product 2</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="order-qty-main-div">
                                                    ...
                                                    <input  value="{{ old('quantity', $inventory->quantity) }}" name="quantity" type="number" class="form-control"
                                            ...
                                            <div class="col-sm-2">
                                                <div class="unreceived-qty-main-div">
                                                    <label for="unreceived-qty" class="form-label">Unreceived
                                                        Qty</label>
                                                    <input  value="{{ old('unreceived', $inventory->unreceived) }}" name="unreceived" type="number"
                                            ...
                                            <div class="col-sm-2">
                                                <div class="unit-cost-main-div">
                                                    <label for="unit-cost" class="form-label">Per Unit
                                                        Cost</label>
                                                    <input  value="{{ old('unit_cost', $inventory->unit_cost) }}" name="unit_cost" type="number"
                                            ...
                                            <div class="col-sm-2">
                                                <div class="total-cost-main-div">
                                                    <label for="total-cost" class="form-label">Total
                                                        Cost</label>
                                                    <input  value="{{ old('total', $inventory->total) }}" name="total" type="number" class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4 total-cost">
                                                <div class="inner-inner-inner">
                                                    ...
                                                    <input  value="{{ old('customer_name', $inventory->customer_name ?? '0.00') }}" type="number" id="subtotal" name="subtotal"
                                                        class="total" disabled value="0.00">
                                                </div>
                                                <div class="inner-inner-inner">
                                                    <h5 style="color:green;">DISCOUNT RECIEVE (-)</h5>
                                                    <input  value="{{ old('discount', $inventory->discount ?? '0.00') }}" type="number" id="discount" name="discount"
                                                        class="total" disabled value="0.00">
                                                </div>
                                                <div class="inner-inner-inner">
                                                    <h5>SALES TAX PAID</h5>
                                                    <input  value="{{ old('tax_paid', $inventory->tax_paid ?? '0.00') }}" type="number" id="tax_paid" name="tax_paid"
                                                        class="total" disabled value="0.00">
                                                </div>
                                                <div class="inner-inner-inner">
                                                    <h5>SHIPPING/FREIGHT PAID</h5>
                                                    <input  value="{{ old('ship_cost', $inventory->ship_cost ?? '0.00') }}" type="number" id="ship_cost" name="ship_cost"
                                                        class="total" disabled value="0.00">
                                                </div>
                                                <div class="inner-inner-inner">
                                                    <h5>GRADN TOTAL</h5>
                                                    <input  value="{{ old('grand_total', $inventory->grand_total ?? '0.00') }}" type="number" id="grand_total" name="grand_total"
                                                        class="total" disabled value="0.00">
                                                </div>
