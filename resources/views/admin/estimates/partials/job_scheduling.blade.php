    ...
    <div class="col-md-8">
        <div class="form-group">
            <select id="fruits" name="current_status" class="form-control">
                <option value="">Quotation Request</option>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <input type="checkbox" name="notify_tech_assign" placeholder="Location Name(e.g Home or Office)"> Notifiy
            all tech(s)assigned
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="form-group">
            <textarea class="form-control" name="notes_for_tech" placeholder="Technical Instructions."></textarea>
...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="form-group">
            <textarea class="form-control" name="completion_notes" placeholder="Finish Notes."></textarea>
