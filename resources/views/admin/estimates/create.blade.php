    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">    
                <form id="myForm" action="{{route('estimates.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                                        ...
                                        <div class="tab-content mt-3">
                                            <div id="single-invoice" class="tab-pane fade show active">
                                                <ul class="nav nav-tabs mt-4">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" data-toggle="tab" href="#products-services">Estimate</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content mt-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row mt-3 invoice">
                                                            <div class="col">
                                                                <p>Estimates Total</p>
                                                                <p>Job Cost</p>
                                                                <p>Gross Profit <span id="est-gross-profit-percentage">(0.00%)</span></p>
                                                            </div>
                                                            <div class="col">
                                                                <p><span id="est-product-and-service-taxes-and-fees">$0.00</span></p>
                                                                <p><span id="est_total_cost">$0.00</span></p>
                                                                <p style="color:#09af2f"><span id="est-gross-profit">$0.00</span></p>
                                                            </div>
                                                        </div>
                                                    </div>    
                                                </div>
