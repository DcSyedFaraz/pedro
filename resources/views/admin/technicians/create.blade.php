    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('admin/technicians/edit.create_technician') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">{{ __('admin/technicians/edit.create_technician') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <div class="col-sm-2">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-control" name="billing_address"
                                                    ...
                                                    <option value="yes"
                                                        {{ old('billing_address') == 'yes' ? 'selected' : '' }}>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-control" name="contact_type"
                                                    ...
                                                    <option value="contact 1"
                                                        {{ old('contact_type') == 'contact 1' ? 'selected' : '' }}>
                                                        contact 1</option>
                                                    <option value="contact 2"
                                                        {{ old('contact_type') == 'contact 2' ? 'selected' : '' }}>
                                                        contact 2</option>
                                                </select>
                                            </div>
                                        </div>
