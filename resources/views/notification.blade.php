...
.notification-list .notification-list_feature-img img {
    ...
    <div class="content-wrapper">
        <section class="section-50">
            <div class="container">
                <h3 class="m-b-50 heading-line">{{auth()->user()->notifications->count()}} Notifications <i class="fa fa-bell text-muted"></i></h3>
                <h5 class="">Un-Read </h5>
                    ...
                    <div class="notification-list notification-list--unread">
                        <div class="notification-list_content">
                            ...
                            <div class="notification-list_detail">
                                <p><b>{{$notifications->data['name']}}</b> @if (isset($notifications->data['message']))
                                    {{$notifications->data['message']}}

                                @endif</p>
                                {{-- <p class="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde, dolorem.</p> --}}
                                <p class="text-muted"><small>{{$notifications->created_at->diffForHumans()}}</small></p>
                            </div>
                        </div>
